package freshmanspecial.mredrock.com.newstudents.engine;
...
public class QQGroupEngine {
    ...
    /*public static void List<QQGroup> getQQgroup(Context context){
        ArrayList<QQGroup> list = new ArrayList<>();
        QQGroup group = new QQGroup();
        for (int i = 0; i < qqInfo.length; i++) {
