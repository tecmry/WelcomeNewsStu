...
public class special_2017_RoundedImageView extends android.support.v7.widget.AppCompatImageView {
    ...
    public special_2017_RoundedImageView(Context context) {
        super(context);
    }

    public special_2017_RoundedImageView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public special_2017_RoundedImageView(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);

        TypedArray a = context.obtainStyledAttributes(attrs,
                R.styleable.special_2017_RoundedImageView, defStyle, 0);

        final int index = a.getInt(R.styleable.special_2017_RoundedImageView_android_scaleType, -1);
        if (index >= 0) {
            setScaleType(sScaleTypeArray[index]);
        }

        mLeftTopCornerRadius = a.getDimensionPixelSize(
                R.styleable.special_2017_RoundedImageView_riv_left_top_corner_radius, 0);
        mRightTopCornerRadius = a.getDimensionPixelSize(
                R.styleable.special_2017_RoundedImageView_riv_right_top_corner_radius, 0);
        mLeftBottomCornerRadius = a.getDimensionPixelSize(
                R.styleable.special_2017_RoundedImageView_riv_left_bottom_corner_radius, 0);
        mRightBottomCornerRadius = a.getDimensionPixelSize(
                R.styleable.special_2017_RoundedImageView_riv_right_bottom_corner_radius, 0);
        ...
        mBorderWidth = a.getDimensionPixelSize(
                R.styleable.special_2017_RoundedImageView_riv_border_width, 0);
        if (mBorderWidth < 0) {
            throw new IllegalArgumentException("border width cannot be negative.");
        }

        mBorderColor = a
                .getColorStateList(R.styleable.special_2017_RoundedImageView_riv_border_color);
        if (mBorderColor == null) {
            mBorderColor = ColorStateList.valueOf(DEFAULT_BORDER_COLOR);
        }

        isOval = a.getBoolean(R.styleable.special_2017_RoundedImageView_riv_oval, false);
        a.recycle();
